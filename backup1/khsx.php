...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['sks_kumulatif'])) {
        $error_sks_kumulatif = "Masukkan SKS Kumulatif";
        $submit = false;
    } else {
    ...
    if (empty($_POST['ip'])) {
        $error_ip = "Wajib isi, tidak boleh kosong";
        $submit = false;
    } else {
    ...
    if (empty($_POST['ipk'])) {
        $error_ipk = "Nomor ipk tidak boleh kosong";
        $submit = false;
    } else {
            ...
            <div id="content">
              ...
              <form>   
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">                        
                    <input type="text" name="sks" id="sks" class="form-control" value="<?php if (isset($sks)) echo $sks; ?>">
                    <!-- <div id="error_name" style="color: red;">
                ...
                <div class="row mb-3">
                    <label for="sks_kumulatif" class="col-sm-2 col-form-label">SKS Kumulatif</label>
                    <div class="col-sm-10">                        
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">                        
                    <input type="text" name="ip" id="ip" class="form-control" value="<?php if (isset($ip)) echo $ip; ?>">
                    <!-- <div id="error_name" style="color: red;">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">                        
                    <input type="text" name="ipk" id="ipk" class="form-control" value="<?php if (isset($ipk)) echo $ipk; ?>">
                    <!-- <div id="error_name" style="color: red;">
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Scan KHS</label>
                  <div class="col-sm-10">
